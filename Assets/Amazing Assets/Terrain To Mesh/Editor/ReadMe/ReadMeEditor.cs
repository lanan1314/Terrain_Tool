        ...
        protected override void OnHeaderGUI()
        {
            ...
            GUILayout.BeginHorizontal("In BigTitle");
            {
                ...
                GUILayout.BeginVertical();
                {
                    ...
                    GUILayout.Label(TerrainToMeshAbout.name, GUIStyleTitle);
        ...
        public override void OnInspectorGUI()
        {
            ...
            //Documentation
            {
                ...
                if (LinkLabel(new GUIContent("Open online documentation")))
                    Application.OpenURL(TerrainToMeshAbout.documentationURL);
            }
            ...
            //Forum
            {
                ...
                if (LinkLabel(new GUIContent("Get answers")))
                    Application.OpenURL(TerrainToMeshAbout.forumURL);
            }
            ...
            //Support
            {
                ...
                if (LinkLabel(new GUIContent("Submit a report")))
                    Application.OpenURL("mailto:" + TerrainToMeshAbout.supportMail);
            }
            ...
            //Support
            {
                ...
                if (LinkLabel(new GUIContent("Open publisher page")))
                    Application.OpenURL(TerrainToMeshAbout.publisherPage);
            }
        }
